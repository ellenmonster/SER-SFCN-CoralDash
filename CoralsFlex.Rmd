...
FuncPlotBleach <- function(dat, yaxis_title, free_ymax) {
  ...
  # saveRDS(plots_list, "plots_list.RDS")
  # plots_page <- plotly::subplot(plots_list, titleX = TRUE, titleY = TRUE, shareY = TRUE, nrows = length(plots_list)) # <<<<<<<<<<< PICK UP FROM HERE. IT'S NOT WORKING.
