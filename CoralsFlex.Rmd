...
# DO error capture if not reading coral or sites data in correctly. I don't know why it wasn't reading .csv sites file correctly.
# Do Judd's requested updates IF this dashboard is going to be used
...
packages <- c("flexdashboard", "shiny", "knitr", "gridExtra", "shinyWidgets", "leaflet", "plotly", "DT", "parallel", "rtf", "lubridate", "leaflet.minicharts", "multidplyr", "tidyverse", "htmlwidgets", "RSQLite", "multidplyr")
