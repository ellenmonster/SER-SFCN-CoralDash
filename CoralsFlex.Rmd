...
#### <font size="5"> Instructions for uploading a summary RDS file</font> 
...
textInput("out_prefix", label = "Prefix to append to output files: ", value = paste0(gsub(pattern = "-", replacement = "", x = Sys.Date())), width = "100%")
