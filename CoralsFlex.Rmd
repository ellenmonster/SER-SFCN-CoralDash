...
rv <- reactiveValues(rawdat = NULL, CalcRepSites = NULL, Warn_list = NULL, PC_options = NULL, PC_Site = NULL, SS_PointCount = NULL, SS_PercCov = NULL, RC_Site = NULL, Bleach = NULL, mapdat = NULL, coraldat = NULL)
...
br(),
  ...
  radioButtons("sel_error",
    ...
    renderUI({
      shiny::req(!is.null(rv$mapdat), !is.null(input$sel_spatialscale), !is.null(input$PCactive))
